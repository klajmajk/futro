<?php
// source: C:\wamp\www\futro\app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_l, $_g) = $template->initialize('4976771600', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb406f1ca71d_head')) { function _lb406f1ca71d_head($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb360549d8b2_content')) { function _lb360549d8b2_content($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_l->blocks['scripts'][] = '_lba94cd543fb_scripts')) { function _lba94cd543fb_scripts($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
