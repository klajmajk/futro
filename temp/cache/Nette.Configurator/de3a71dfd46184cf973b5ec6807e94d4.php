<?php
// source: C:\Users\novot_000\OneDrive\dev\futro\app/config/config.neon 
// source: C:\Users\novot_000\OneDrive\dev\futro\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\Users\\novot_000\\OneDrive\\dev\\futro\\app',
			'wwwDir' => 'C:\\Users\\novot_000\\OneDrive\\dev\\futro\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\Users\\novot_000\\OneDrive\\dev\\futro\\app/../temp',
		));
	}
	...
	{
		$service = new Authenticator($this->getService('nette.database.default.context'), $this->getService('authorizator'));
		return $service;
	}
	...
	public function createServiceAuthorizator()
	{
		...
		$service->addRole('kumpan', 'guest');
		$service->addRole('beer_manager', 'kumpan');
		$service->addRole('super_admin', 'beer_manager');
		$service->addResource('presentation');
		$service->addResource('beer_management');
		$service->allow('kumpan', 'presentation', 'view');
		$service->allow('beer_manager', 'beer_management');
		$service->allow('super_admin');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\Users\\novot_000\\OneDrive\\dev\\futro\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	public function createServiceHttpResponse()
	{
		...
		if (!$service instanceof Nette\Http\Response) {
			throw new Nette\UnexpectedValueException('Unable to create service \'httpResponse\', value returned by factory is not Nette\\Http\\Response type.');
		}
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\Users\\novot_000\\OneDrive\\dev\\futro\\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=futro', 'root', 'root', array('lazy' => TRUE));
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('C:\\Users\\novot_000\\OneDrive\\dev\\futro\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\Users\\novot_000\\OneDrive\\dev\\futro\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\Users\\novot_000\\OneDrive\\dev\\futro\\app/../temp/cache', $this->getService('nette.cacheJournal'));
	...
	{
		$service = new Drahak\Restful\Application\CachedRouteListFactory('C:\\Users\\novot_000\\OneDrive\\dev\\futro\\app', $this->getService('restful.routeListFactory'), $this->getService('cacheStorage'));
		return $service;
	}
	...
	{
		$service = new Drahak\Restful\Application\RouteListFactory('C:\\Users\\novot_000\\OneDrive\\dev\\futro\\app', $this->getService('cacheStorage'), $this->getService('restful.routeAnnotation'));
		$service->setModule('Api');
		$service->setPrefix('futro');
		return $service;
	}
