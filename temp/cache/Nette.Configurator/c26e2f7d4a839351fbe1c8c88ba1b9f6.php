...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'app\\model\\kumpan' => array('57_App_Model_Kumpan'),
			'app\\model\\sud' => array('58_App_Model_Sud'),
			'nette\\security\\iauthenticator' => array('59_App_Model_UserManager'),
			'app\\model\\usermanager' => array('59_App_Model_UserManager'),
			'app\\model\\vytoc' => array('60_App_Model_Vytoc'),
		...
		'tags' => array(
			'restful.converter' => array(
				...
				'restful.snakeCaseConverter' => TRUE,
			),
		),
	);
	...
	/**
	 * @return App\Model\Kumpan
	 */
	public function createService__57_App_Model_Kumpan()
	{
		$service = new App\Model\Kumpan($this->getService('nette.database.default.context'));
		return $service;
	}


	/**
	 * @return App\Model\Sud
	 */
	public function createService__58_App_Model_Sud()
	{
		$service = new App\Model\Sud($this->getService('nette.database.default.context'));
		return $service;
	}
	...
	/**
	 * @return App\Model\Vytoc
	 */
	public function createService__60_App_Model_Vytoc()
	{
		$service = new App\Model\Vytoc($this->getService('nette.database.default.context'));
		return $service;
	}
	...
	public function createServiceRestful__resourceConverter()
	{
		...
		$service->addConverter($this->getService('restful.snakeCaseConverter'));
		return $service;
	}
