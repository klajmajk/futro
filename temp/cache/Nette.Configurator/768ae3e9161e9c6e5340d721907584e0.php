<?php
// source: C:\wamp\www\futro\app/config/config.neon 
// source: C:\wamp\www\futro\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\wamp\\www\\futro\\app',
			'wwwDir' => 'C:\\wamp\\www\\futro\\www',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			...
			'tempDir' => 'C:\\wamp\\www\\futro\\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\wamp\\www\\futro\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\wamp\\www\\futro\\app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('C:\\wamp\\www\\futro\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\wamp\\www\\futro\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\wamp\\www\\futro\\app/../temp/cache', $this->getService('nette.cacheJournal'));
	...
	{
		$service = new Drahak\Restful\Application\CachedRouteListFactory('C:\\wamp\\www\\futro\\app', $this->getService('restful.routeListFactory'), $this->getService('cacheStorage'));
		return $service;
	}
	...
	{
		$service = new Drahak\Restful\Application\RouteListFactory('C:\\wamp\\www\\futro\\app', $this->getService('cacheStorage'), $this->getService('restful.routeAnnotation'));
